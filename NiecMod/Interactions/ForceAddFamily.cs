...
{
    public sealed class ForceAddFamily: ImmediateInteraction<Sim, Sim>
    {
        ...
        public override bool Run() // Run
        {
        	...
        	{
        		if (!AcceptCancelDialog.Show("Warning: Add Active Family " + Target.Name + "?")) return false;
        		{
        ...
        private sealed class Definition : ImmediateInteractionDefinition<Sim, Sim, ForceAddFamily>, IAllowedOnClosedVenues, IOverridesAgeTests, IUseTargetForAutonomousIsAllowedInRoomCheck, IScubaDivingInteractionDefinition, IUsableWhileOnFire, IUsableDuringFire, IUsableDuringBirthSequence, IUsableDuringShow
        {
            public override string GetInteractionName(Sim actor, Sim target, InteractionObjectPair interaction)
            {
                return Localization.LocalizeString("NiecMod/Interactions/Force:AddFamily", new object[0]);
            }
