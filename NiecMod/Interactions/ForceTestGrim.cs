...
{
    public sealed class ForceTestGrim: ImmediateInteraction<Sim, Sim>
    {
        ...
        private sealed class Definition : ImmediateInteractionDefinition<Sim, Sim, ForceTestGrim>, IAllowedOnClosedVenues, IOverridesAgeTests, IUseTargetForAutonomousIsAllowedInRoomCheck, IScubaDivingInteractionDefinition, IUsableWhileOnFire, IUsableDuringFire, IUsableDuringBirthSequence, IUsableDuringShow
        {
