...
{
    /// <summary>
    /// This a Prevent cancel
    /// Name is Pause Cancel Interaction 
    /// Prevent Cancel All Interactions Prevent OnReset Interaction And Prevent Cancel Interaction
    /// </summary>
    public sealed class AllPauseNiecDone : Interaction<Sim, Sim>
    {
        ...
        public override bool Run() // Run
        {
            try
            {
                if (Actor.IsInActiveHousehold)
                {
                    ...
                    base.EnterStateMachine("ActAgitated", "Enter", "x");
                    base.AnimateSim("ActAgitated");
                ...
                {
                    Actor.LoopIdle();
                    bool DoLoopAGSAse = base.DoLoop(ExitReason.CanceledByScript);
        ...
        private sealed class Definition : InteractionDefinition<Sim, Sim, AllPauseNiecDone>, IAllowedOnClosedVenues, IOverridesAgeTests, IUseTargetForAutonomousIsAllowedInRoomCheck, IScubaDivingInteractionDefinition, IUsableWhileOnFire, IUsableDuringFire, IUsableDuringBirthSequence, IUsableDuringShow
        {
            public override string GetInteractionName(Sim actor, Sim target, InteractionObjectPair interaction)
            {
                return Localization.LocalizeString("NiecS3Mod/Interaction:PauseNiecIns", new object[0]);
                //return "Pause Cancel Interaction";
            }
