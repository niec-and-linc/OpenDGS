...
namespace NiecMod.Interactions.Objects
{
    public sealed class NiecObjectAsktoAdd : ImmediateInteraction<Sim, NiecAutoKill>
    {
        ...
        public override bool Run()
        {
            ...
            if (targetsim != null)
            {
                targetsim.InteractionQueue.Add(NiecAutoKill.KillSimNiec.Singleton.CreateInstance(Target, targetsim, base.GetPriority(), false, true));
            }
            return true;
        }
        ...
        private sealed class Definition : ImmediateInteractionDefinition<Sim, NiecAutoKill, NiecObjectAsktoAdd>, IAllowedOnClosedVenues, IOverridesAgeTests, IUseTargetForAutonomousIsAllowedInRoomCheck, IScubaDivingInteractionDefinition, IUsableWhileOnFire, IUsableDuringFire, IUsableDuringBirthSequence, IUsableDuringShow
        {
