    ...
    public class ArrestSuspectSituation : RootSituation
    {
        ...
        private class CreateCopAndRoute : ChildSituation<ArrestSuspectSituation>
        {
            ...
            public override void Init(ArrestSuspectSituation parent)
            {
                ...
                else
                {
                    ...
                    base.ForceSituationSpecificInteraction(parent.Cop, parent.Cop, new ArrestSuspectSituation.GoToCulpritsLocation.Definition(base.Parent), null, new Callback(this.OnCompletion), new Callback(this.OnFailure), new InteractionPriority((InteractionPriorityLevel)99));
                }
            }
        ...
        private class GetCulpritInCar : ChildSituation<ArrestSuspectSituation>
        {
            ...
            public override void Init(ArrestSuspectSituation parent)
            {
                ...
                cop.FlagSet(Sim.SimFlags.IgnoreDoorLocks, true);
                base.ForceSituationSpecificInteraction(base.Parent.CopCar, base.Parent.Cop, new ArrestSuspectSituation.GetInPoliceCar.Definition(base.Parent), null, new Callback(this.OnCompletion), new Callback(this.OnFailure), new InteractionPriority((InteractionPriorityLevel)99));
            }
        ...
        private class MakeArrest : ChildSituation<ArrestSuspectSituation>
        {
            ...
            public void ArrestFinished(Sim actor, float x)
            {
                ...
                InteractionInstance entry = definition.CreateInstance(this.arrestSituation.CopCar, this.arrestSituation.SimToArrest, new InteractionPriority((InteractionPriorityLevel)99), false, false);
            ...
            public override void Init(ArrestSuspectSituation parent)
            {
                if (base.Parent.SimToArrest != null)
                {
                    ...
                    InteractionInstance instance = base.ForceSituationSpecificInteraction(parent.SimToArrest, parent.Cop, i, null, new Callback(this.ArrestFinished), new Callback(this.ArrestFailure), ((InteractionPriorityLevel)99));
                    if (instance != null)
                    {
